...
public class registroEmpresa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ingresarInfo.registroCliente(usu, contrasena, correo, respuestaSegu, fechaCreacion, estado, nombre1, nombre2, apellido1, null, pais, documento, ciudad, direccion, telefono, idRol);
