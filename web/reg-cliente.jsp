<%-- 
    ...
    Created on : 9/03/2016, 01:18:45 PM
...
<html lang="en">
    ...
    <body>
        ...
        <section  class="registro">
            <br>
            <br>
            <h1 class="title-registro"><b>Registrate como cliente</b></h1>
                ...
                <div class="list1">
                    ...
                    <ul class="list-items list-items-mod1">
                        ...
                        <div class="list-mod-li"><li>
                                ...
                                <p><label class="Label">Primer nombre: </label></p> 
                                <input maxlength="20" id="txtnombre1" name="nombre1" type="text" placeholder="Nombre 1"  class="mod__input" onkeypress="return validar(event)" autofocus/>
                            </li>
                            <li>
                                <p><label class="Label">Segundo nombre: </label></p>
                                <input maxlength="20" id="txtnombre2" name="Nombre2" type="text" placeholder="Nombre 2"  class="mod__input" onkeypress="return validar(event)" />
                            </li>
                            <li>
                                <p><label class="Label">Primer apellido: </label></p>
                                <input maxlength="20" id="txtapellido1" name="Apellido1" type="text" placeholder="Apellido 1"  class="mod__input" onkeypress="return validar(event)" required/>
                            </li>
                        </div>
                        <div class="list-mod-li"><li>               
                                <p><label class="Label">Segundo apellido: </label></p>
                                <input maxlength="20" id="txtapellido2" name="Apellido2" type="text" placeholder="Apellido 2" class="mod__input" onkeypress="return validar(event)"/>
                            </li>
                            <li>               
                                <p><label class="Label">Documento: </label></p>
                                <input maxlength="20" id="txtdocumento" name="DocIdentity" type="text" placeholder="Documento de identidad" class="mod__input" onkeypress="ValidaSoloNumeros()" required/>
                            </li>
                        ...
                        <div class="list-mod">
                            ...
                            <li>
                                <p><label class="Label">Respuesta de seguridad: </label></p>
                    ...
                    <div class="button-item2">
                        <input id="registroCliente" class="enviarbut" type="submit" value="Enviar">
